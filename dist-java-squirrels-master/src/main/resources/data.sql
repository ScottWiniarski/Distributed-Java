insert into squirrel(squirrel_id, species, common_name, habitat, image_file_name, rating)
values(1, 'Ratufa macroura', 'Grizzled giant squirrel', 'Sri Lanka', 'ggs.jpg', 1);

insert into squirrel(squirrel_id, species, common_name, habitat, image_file_name, rating)
values (2, 'Petaurista philippensis', 'Indian giant flying squirrel', 'India and China', 'igfs.jpg', 2);

insert into squirrel(squirrel_id, species, common_name, habitat, image_file_name, rating)
values (3, 'Pteromys momonga', 'Japanese dwarf flying squirrel', 'Japan', 'jdfs.jpg', 2);

insert into squirrel(squirrel_id, species, common_name, habitat, image_file_name, rating)
values (4, 'Petaurista petaurista', 'Red giant flying squirrel', 'Southeast Asia', 'grfs.jpg', 2);

insert into squirrel(squirrel_id, species, common_name, habitat, image_file_name, rating)
values (5, 'Callosciurus prevostii', 'Prevost''s squirrel', 'Thai-Malay Peninsula', 'ps.jpg', 3);

insert into squirrel(squirrel_id, species, common_name, habitat, image_file_name, rating)
values (6, 'Ratufa indica', 'Malabar giant squirrel', 'India', 'mgs.jpg', 3);

insert into squirrel(squirrel_id, species, common_name, habitat, image_file_name, rating)
values (7, 'Supreme Nutstealer', 'Goliath', 'Brooklyn', 'StrongSquirrel.jpg', 5);
